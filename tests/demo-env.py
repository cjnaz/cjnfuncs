...
print ("toolname:         ", toolname.toolname)
print ("user_config_dir:  ", toolname.user_config_dir)
print ("site_config_dir:  ", toolname.site_config_dir)
print ("data_dir:         ", toolname.data_dir)
print ("state_dir:        ", toolname.state_dir)
print ("cache_dir:        ", toolname.cache_dir)
print ("log_dir:          ", toolname.log_dir)
print ("log_file:         ", toolname.log_file)
print ("log_full_path:    ", toolname.log_full_path)
